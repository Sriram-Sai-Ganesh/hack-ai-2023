...
def video():
    ...
    while True:
        ...
        if len(lmlist) != 0:
            ...
            print(knnInput)
            print (knnModel.predict([[-57,190,27,173,95,132,125,81,142,34,45,14,67,-57,78,-103,88,-144,0,0,22,-82,37,-137,53,-184,-46,1,-29,-76,-10,-125,11,-167,-96,15,-89,-49,-77,-86,-59,-120]]))
